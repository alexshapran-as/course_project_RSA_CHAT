...
{
    QString temp = "Чат с шифрованием RSA. Все ваши сообщения будут защищены и надежно сохранены! Приятного пользования:)";
    QMessageBox::information(this, "Информация", temp);
